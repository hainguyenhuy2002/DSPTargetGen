...
def _vllm_generate(llm, prompts: list[str], sampling_params: SamplingParams) -> list[str]:
...
def run_description_pipeline(
    ...
    *,
    ...
    log.info("Description pipeline: %d drugs to process (use_cid_fallback=%s)",
             len(todo), use_cid_fallback)
